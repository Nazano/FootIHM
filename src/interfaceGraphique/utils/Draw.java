...
public class Draw {
	...
	public Fx3DGroup createPlayer(Joueur j)
	{
        ...
        //Create Fx3DGroup
        Fx3DGroup player ;
        player= new Fx3DGroup(meshViews); 
	...
	public Fx3DGroup createBillboard(Joueur j)
	{
        ...
        String file = "/assets/soccer/" ;
        if(id<10)
        {
        	file = file + "0" + id.toString()+ ".png";
        }else
        {
        	file = file + id.toString()+ ".png";
        }

        material.setDiffuseMap(new Image(getClass().getResourceAsStream(file)));
        boxBB.setMaterial(material);
        billboard.set3DTranslate(j.getX_pos()-52, 0, j.getY_pos()-34);
